                            ...
                            <?php foreach ($perijinan_add as $pa) { ?>
                                <form action="<?php echo base_url() . 'perijinan_add/update'; ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="text" class="form-control" name="surat_ijin_no" id="surat_ijin_no" placeholder="No. Surat Ke PTSP" value="<?php echo $pa->spj_no ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" class="form-control" name="tgl_surat" id="datepick" value="<?php echo $pa->tgl_surat ?>">
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10"><input type="text" class="form-control" name="pekerjaan" value="<?php echo $pa->pekerjaan ?>"></div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <select class="form-control m-b-10" name="kota_adm" value="<?php echo $pa->kota_adm ?>">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-10">
                                            <textarea class="form-control" name="lokasi" value="<?php echo $pa->lokasi ?>"></textarea>
                                        </div>
                                    </div>
